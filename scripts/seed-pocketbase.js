#!/usr/bin/env node
// Seed script for PocketBase (improved): creates departments and 30 profiles linked to departments
// Usage:
//   node scripts/seed-pocketbase.js --url http://127.0.0.1:8090 --admin-email admin@example.com --admin-password secret
